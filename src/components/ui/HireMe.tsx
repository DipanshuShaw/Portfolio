...
const HireMe = () => {
  return (
    <button className="relative inline-flex h-10 mx-2 sm:mx-4 overflow-hidden rounded-2xl p-[2px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
