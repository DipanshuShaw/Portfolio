...
export const Card = React.memo(
  ({
    ...
    <div
      ...
      className={cn(
        "rounded-lg relative bg-gray-100 dark:bg-neutral-900 overflow-hidden h-60 min-[500px]:h-72 min-[700px]:h-80 max-[1200px]:h-80  xl:h-96 w-full transition-all duration-300 ease-out",
